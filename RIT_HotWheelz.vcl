...
Process_Engage:
		...
		If ((Down_Button = On)&(Button_Press_Flag = OFF)&((Debounce_DLY_Output = 0))) ;check if the operator wants to see the faults
			{		
		...
		else if((Down_Button = On)&(Button_Press_Flag = ON)&((Debounce_DLY_Output = 0))) ;check if the operator wants to see the gauges
			{		
